...
ifeq ($(KERNEL_DEFCONFIG),)
    ifeq ($(TARGET_BUILD_VARIANT),user)
        KERNEL_DEFCONFIG := sdmsteppeauto-qgki_defconfig
    else
        KERNEL_DEFCONFIG := sdmsteppeauto-qgki-debug_defconfig
    endif
endif
